...
<div class="p_relative">
	...
	<div class="box" id="Profile_box">
		<img class="p_absolute" id="Picture" src="<?php echo base_url();?>/images/ProfilePic.png"></img>
	...
	<div class="box" id="Interest_Box">
		<img class="p_absolute" src="<?php echo base_url();?>/images/Interests.png" width="230px" height="150px" style="border-top-left-radius: 5px; border-top-right-radius: 5px;">
	...
	<div class="box" id="Hobbies_Box">
		...
		<img class="bubble_height" id="bubble1" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 30px; width: 120px"> </img>
		<p class="para2_white" id="p1" style="margin-left: 42px"> Play Table Tennis </p>
			
		<img class="bubble_height" id="bubble2" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 160px; width: 105px"> </img>
		<p class="para2_white" id="p2" style="margin-left: 172px"> Watch Movies </p>
		
		<img class="bubble_height" id="bubble3" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 275px; width: 110px"> </img>
		<p class="para2_white" id="p3" style="margin-left: 287px; "> Listen to Music </p>
			
		<img class="bubble_height" id="bubble4" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 30px; width: 155px"> </img>
		<p class="para2_white" id="p4" style="margin-left: 40px; "> Make DIY Pop Up Cards </p>
			
		<img class="bubble_height" id="bubble5" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 195px; width: 95px"> </img>
		<p class="para2_white" id="p5" style="margin-left: 208px; "> Read Books </p>

		<img class="bubble_height" id="bubble6" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 300px; width: 85px"> </img>
		<p class="para2_white" id="p6" style="margin-left: 312px"> Go Fishing </p>

		<img class="bubble_height" id="bubble7" src="<?php echo base_url();?>/images/Bubble.png" style="margin-left: 30px; width: 130px"> </img>
